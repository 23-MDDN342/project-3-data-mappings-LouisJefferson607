...
function Face(eye_value, mouth_value, chocolate_value, NS, chocolate_size) {
  ...
  this.eye_value = int(random(3, 8));
  this.mouth_value = random(0, 150);
  this.chocolate_value = int(random(0, 14));
  this.height_cook = int(random(canvasHeight / 2 - 140, canvasHeight / 2 + 140));
  this.width_cook = int(random(canvasWidth /  2 - 250, canvasWidth / 2 + 250));
  this.chocolate_size = int(random(1, 2));
